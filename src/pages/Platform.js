...
const TASK_MODULES = {
  ...
  'idea-worksheet': { headline: 'Lock in your idea', intro: `Time to put your concept on paper. Answer these questions and you'll have your official business idea.`, coachOpener: `Let's lock in your idea! By the end of this chat, you'll have a short written description you can share with anyone.\n\nStart simple: What is your product or service? Describe it in one or two sentences.`, guidePrompts: [`Good! Who is your customer — the main person you're selling to? Be specific.`, `What problem does your product solve for them? Why would they pay money for it?`, `Who else sells something similar? Name a competitor and one thing you'll do better.`, `What's your product actually made of, or how does your service work step-by-step?`, `Give your business a name. Doesn't have to be final — just something you like for now.`], doneMessage: `Your idea is documented! Product, customer, problem, competitor, name. That's a real business concept. Mark it done?` },
